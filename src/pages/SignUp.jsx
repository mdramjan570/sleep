...
//       <div className="items-center justify-center w-full h-full grid-cols-3 mx-auto  md:grid">
//         <div className="items-center justify-center flex-1 hidden w-full h-full min-h-full col-span-2 mx-auto bg-no-repeat md:flex dark:bg-darkish ">
//           <Player
//             autoplay
//             loop
...
//                 />
//                 {errors.avatar && (
//                   <p className="mt-2 text-sm text-left text-danger">
...
//                 </Button>
//               </form>
//               <div className="mt-5 text-center text-muted-foreground text-tiny">
